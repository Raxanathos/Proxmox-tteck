...
function header_info {
  cat <<"EOF"
    ____                        __  _         
   / __ \____  ____ ___  ____  / /_(_)________
...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/raxanathos/Proxmox-tteck/main/install/$var_install.sh)" || exit
IP=$(pct exec $CTID ip a s dev eth0 | sed -n '/inet / s/\// /p' | awk '{print $2}')
pct set $CTID -description "# ${APP} LXC
### https://github.com/Raxanathos/Proxmox-tteck
